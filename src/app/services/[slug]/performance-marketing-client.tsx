          ...
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center">
              <Link href="/" className="flex-shrink-0">
                <span className="text-orange-400 font-bold text-2xl">MIDAS</span>
              </Link>
              <div className="hidden md:block ml-10">
                <div className="flex items-center space-x-8">
                  ...
                  <Link href="/#services" className="text-orange-400 hover:text-orange-300 px-3 py-2 rounded-md text-sm font-medium">
                    Services
                  </Link>
        ...
        {mobileMenuOpen && (
          <div className="md:hidden bg-gray-900 py-2 border-t border-gray-800">
            <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
              ...
              <Link href="/#services" className="block text-orange-400 hover:text-orange-300 px-3 py-2 rounded-md text-base font-medium">
                Services
              </Link>
