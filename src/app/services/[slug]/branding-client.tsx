    ...
    <div className="min-h-screen bg-gray-950 text-gray-200">
          ...
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center">
              <Link href="/" className="flex-shrink-0">
                <span className="text-purple-400 font-bold text-2xl">MIDAS</span>
              </Link>
              <div className="hidden md:block ml-10">
                <div className="flex items-center space-x-8">
                  ...
                  <Link href="/#services" className="text-purple-400 hover:text-purple-300 px-3 py-2 rounded-md text-sm font-medium">
                    Services
                  </Link>
        ...
        {mobileMenuOpen && (
          <div className="md:hidden bg-gray-900 py-2 border-t border-gray-800">
            <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
              ...
              <Link href="/#services" className="block text-purple-400 hover:text-purple-300 px-3 py-2 rounded-md text-base font-medium">
                Services
              </Link>
          ...
          >
            <div className="md:max-w-2xl">
              ...
              <div className="flex flex-wrap gap-3">
                <span className="bg-purple-400/20 text-purple-400 px-3 py-1 rounded-full text-sm font-medium">Identity</span>
                <span className="bg-purple-400/20 text-purple-400 px-3 py-1 rounded-full text-sm font-medium">Design</span>
                <span className="bg-purple-400/20 text-purple-400 px-3 py-1 rounded-full text-sm font-medium">Strategy</span>
              </div>
            </div>
            <motion.div 
              variants={scaleIn}
                  ...
                  <Accordion type="single" collapsible className="w-full">
                    {service.features.map((feature, index) => (
                      <AccordionItem key={index} value={`feature-${index}`} className="border-gray-700">
                        <AccordionTrigger className="text-lg text-white hover:text-purple-400 transition-colors py-4">
                          {feature.split(':')[0]}
                        </AccordionTrigger>
                ...
                <div className="space-y-12">
                  {service.process.map((step, index) => (
                    <div key={index} className="relative">
                      {/* Process step number */}
                      <div className="absolute -left-4 -top-4 h-12 w-12 rounded-full bg-purple-400 flex items-center justify-center text-gray-900 font-bold text-xl">
                        {index + 1}
                      </div>
                      
                      <div className="ml-8 pl-4 border-l-2 border-purple-400/30">
      ...
      <div className="py-12 bg-gray-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold mb-6 text-white">Ready to Build a Memorable Brand?</h2>
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">Let our creative team craft a strong, distinctive identity that resonates with your audience.</p>
            <Link 
              href="/contact" 
              className="inline-block bg-purple-400 hover:bg-purple-500 text-gray-900 font-semibold px-8 py-3 rounded-lg text-lg transition-colors"
            >
              Get In Touch
            </Link>
          </motion.div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="mb-4 md:mb-0">
              <span className="text-purple-400 font-bold text-xl">MIDAS</span>
