          ...
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center">
              <Link href="/" className="flex-shrink-0">
                <span className="text-yellow-400 font-bold text-2xl">MIDAS</span>
              </Link>
              <div className="hidden md:block ml-10">
                <div className="flex items-center space-x-8">
                  ...
                  <Link href="/#services" className="text-yellow-400 hover:text-yellow-300 px-3 py-2 rounded-md text-sm font-medium">
                    Services
                  </Link>
        ...
        {mobileMenuOpen && (
          <div className="md:hidden bg-gray-900 py-2 border-t border-gray-800">
            <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
              ...
              <Link href="/#services" className="block text-yellow-400 hover:text-yellow-300 px-3 py-2 rounded-md text-base font-medium">
                Services
              </Link>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="mb-4 md:mb-0">
              <span className="text-yellow-400 font-bold text-xl">MIDAS</span>
